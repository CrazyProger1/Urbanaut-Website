...
export const getSecurityColorClass = (security?: APISecurityLevel) => {
  return cn(
    security === "NONE" && "bg-security-none border-security-none",
    security === "EASY" && "bg-security-easy border-security-easy",
    security === "MEDIUM" && "bg-security-medium border-security-medium",
    security === "HARD" && "bg-security-hard border-security-hard",
    security === "IMPOSSIBLE" && "bg-security-impossible border-security-impossible",
    !security && "bg-security-none border-security-none",
  );
};

export const getPreservationColorClass = (preservation?: APIPreservationLevel) => {
  return cn(
    preservation === "NONE" && "bg-preservation-none border-preservation-none",
    preservation === "LOW" && "bg-preservation-low border-preservation-low",
    preservation === "MEDIUM" && "bg-preservation-medium border-preservation-medium",
    preservation === "HIGH" && "bg-preservation-high border-preservation-high",
    preservation === "AWESOME" && "bg-preservation-awesome border-preservation-awesome",
    !preservation && "bg-preservation-none border-preservation-none",
  );
};
